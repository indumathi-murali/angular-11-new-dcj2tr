  ...
  public layers: object[] = [
    {
      ...
      markerSettings: [
        ...
        },
        {
          visible: true,
          template:
            '<div id="marker1" class="markersTemplate" style="color:white;">Asia' +
            '</div>',
        ...
        },
        {
          visible: true,
          template:
            '<div id="marker2" class="markersTemplate" style="color:white;">Australia' +
            '</div>',
        ...
        },
        {
          visible: true,
          template:
            '<div id="marker3" class="markersTemplate" style="color:white;">Africa' +
            '</div>',
        ...
        },
        {
          visible: true,
          template:
            '<div id="marker4" class="markersTemplate" style="color:white;">Europe' +
            '</div>',
          dataSource: [
        ...
        },
        {
          visible: true,
          template:
            '<div id="marker5" class="markersTemplate" style="width:50px;color:white;">North America' +
            '</div>',
          dataSource: [
        ...
        },
        {
          visible: true,
          template:
            '<div id="marker6" class="markersTemplate" style="width:50px;color:white;">South America' +
            '</div>',
          dataSource: [
